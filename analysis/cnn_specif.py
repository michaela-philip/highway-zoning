...
x_vars_no_int, columns_no_int = build_spec(df_restricted, CORE_VARS, CNN_LOGIT, HOUSING_VARS, LOG_DIST_HWY, HH_CONTROLS, GEO_CONTROLS)
# results_wholesample, *_ = fit_ols(df_restricted, x_vars_no_int, columns_no_int)
# print('wholesample without interactions:', results_wholesample)

# # whole sample - interaction with prob_hwy
x_vars, columns = build_spec(df_restricted, CORE_VARS, CNN_LOGIT, LOGIT_INTERACTIONS, HOUSING_VARS, LOG_DIST_HWY, HH_CONTROLS, GEO_CONTROLS)
# results_wholesample_interaction, *_ = fit_ols(df_restricted, x_vars, columns)
...
print('direct sample without interactions:' , dir_results_interaction)
print('indirect sample without interactions:' , indir_results_no_interaction)
