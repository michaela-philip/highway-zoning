...
# saved_model_filename = 'binaryclass/bc_model3.tar'  # path to saved model for prediction
...
saved_model_filename = f'cnn/binaryclass/bc_model3_{cell_width}.tar'
...
features = ['distance_to_cbd', 'dist_water', 'dist_to_hwy', 'dist_to_rr', 'flood_risk', 'elevation', 'slope', 'owner', 'numprec', 'hwy']
normalize_features = ['distance_to_cbd', 'dist_water', 'dist_to_hwy', 'dist_to_rr', 'elevation', 'owner', 'numprec', 'slope'] # the only features i want to demean
...
filename_out = f'predicted_activation-model3_{cell_width}_{date}.csv'
