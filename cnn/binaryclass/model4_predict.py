...
# saved_model_filename = 'binaryclass/bc_model4.tar'  # path to saved model for prediction
...
saved_model_filename = f'cnn/binaryclass/bc_model4_{cell_width}.tar'
...
filename_out = f'predicted_activation-model4_{cell_width}_{date}.csv'
