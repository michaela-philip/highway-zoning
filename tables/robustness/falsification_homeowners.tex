...
\toprule
 & Coefficient \\
\midrule
Residential & \makecell[tr]{-1.086{**} \\ (0.356)} \\
Exposure to Homeowners & \makecell[tr]{0.077 \\ (0.268)} \\
Residential x Exposure to Homeowners & \makecell[tr]{0.027 \\ (0.247)} \\
Est. Highway Suitability & \makecell[tr]{1.398{***} \\ (0.193)} \\
Residential x High Suitability & \makecell[tr]{1.485 \\ (0.800)} \\
Black x High Suitability & \makecell[tr]{0.127 \\ (0.466)} \\
Residential x Black x High Suitability & \makecell[tr]{-0.157 \\ (0.605)} \\
R-squared & 0.269 \\
Observations & 5236 \\
\bottomrule
\end{tabular*}
